var valueTextAry = new Array();
//ztree 选择框
(function ($) {
    $.extend($.fn, {
        ztreeSelect: function (valueInput, jsonUrl, selfValue, isMulitSelect, isFlag,onCheckCallback,completedCallBack) {
            //选择框所依附的文本框
            console.log(isFlag);
            var dom = this;
            ...
            function onCheck(e, treeId, treeNode) {
                ...
                if (onCheckCallback!=null&&typeof(onCheckCallback) == "function")
                {
