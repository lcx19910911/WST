        ...
        */
        ...
        public static string GetSignature(string url, string token, string timestamp, string nonce)
        {
           ...
           // LogHelper.WriteDebug($"signature={str3}");
            ...
            string str7 = "url=" + url;
            //LogHelper.WriteDebug("ticket:" + str3+ " noncestr:" + nonce+ " timestamp:" + timestamp + "url=" + url);
        ...
        public static string GetCacheToken(string appid, string secret)
        {
        ...
        public static void SetIndustry(string appid,string appsecrect)
        {
            var token = GetCacheToken(appid, appsecrect);
        }
    }
}